...
<div class="bjui-pageContent">
    <form action="/<%=PropKit.get("project_name") %>/admin/good/mallgood/submit/" id="j_custom_form" data-toggle="validate" data-alertmsg="false">
	<table class="table table-condensed table-hover" width="100%">
    	...
    	<tr>
	        <td>
	            ...
	            <input type="text" name="goodname" id="goodname" value="" data-rule="商品名称:required;" size="15">
	        </td>
	     </tr>
	     <tr>
	        <td>
