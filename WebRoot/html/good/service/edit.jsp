...
<div class="bjui-pageContent">
    <form action="/<%=PropKit.get("project_name") %>/admin/good/vipservice/update/" id="j_custom_form" data-toggle="validate" data-alertmsg="false">
    	...
    	<tr>
	        <td>
	            ...
	            <input type="text" name="servicename" id="servicename" value="${servicename}" data-rule="服务名称:required;" size="15">
	        </td>
	     </tr>
	     <tr >
				<td height="200px">
			 ...
			 <tr >
	            ...
	            <div style="display: inline-block; vertical-align: middle;">
	                <div id="imgpath_up" data-toggle="upload" data-uploader="/<%=PropKit.get("project_name") %>/admin/upload/" 
	                    ...
	                    data-icon="cloud-upload"></div>
	                <input type="hidden" name="imgpath1" value="${contentimage}" id="imgpath1">
	                <img src="${contentimage }" id="contentimage" width="100px" height="100px"/>
     ...
     <input id = "serviceid" value="${serviceid }" type ="hidden" name="serviceid"/>
    </form>
</div>
...
function pic_upload_success1(file, data) {
    ...
    if (json[BJUI.keys.statusCode] == BJUI.statusCode.ok) {
        ...
        var imgId2 = document.getElementById("contentimage");
    	imgId2.style.visibility ="hidden";
