...
<div class="bjui-pageContent">
    <form action="/<%=PropKit.get("project_name") %>/admin/good/collegegood/update/" id="j_custom_form" data-toggle="validate" data-alertmsg="false">
    	...
    	<tr>
	        <td>
	            ...
	            <input type="text" name="coursename" id="coursename" value="${coursename}" data-rule="课程名称:required;" size="15">
	        </td>
	     </tr>
	     <tr>
	        <td>
