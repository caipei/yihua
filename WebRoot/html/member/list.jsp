...
<div class="bjui-pageHeader">
	...
	<form id="pagerForm" data-toggle="ajaxsearch"
		action="/<%=PropKit.get("project_name")%>/admin/member/"
		method="post">
        ...
        <tbody>
        	<c:set var="index">1</c:set>
				<c:forEach items="${userlist}" var="mem">
                    	...
                    	<a href="/<%=PropKit.get("project_name") %>/admin/member/detail?id=${mem.id }" class="btn btn-green" data-toggle="navtab" data-id="info_edit" data-reload-warn="本页已有打开的内容，确定将刷新本页内容，是否继续？" data-title="查看">查看</a>
                		</td>
					</tr>
