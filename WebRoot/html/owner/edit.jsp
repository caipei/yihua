...
<div class="bjui-pageContent">
    <form action="/<%=PropKit.get("project_name") %>/admin/owner/update/" id="j_custom_form" data-toggle="validate" data-alertmsg="false">
    	...
    	<tr>
	        <td>
	            ...
	            <input type="text" name="ownername" id="ownername" value="${ownername }" data-rule="业主名称:required;" size="25">
	        </td>
	     </tr>
	     <tr>
	        <td>
	            <label for="mobile" class="control-label x200">业主联系方式：</label>
	            <input type="text" name="mobile" id="mobile" value="${mobile }"  size="25">
	        </td>
	     </tr>
	    <tr>
	        <td>
	     ...
	     <tr>
	        <td>
	            ...
	            <input type="text" name="building" id="building" value="${building }"  size="25">
	        </td>
	     </tr>
	     <tr>
	        <td>
	            <label for="unit" class="control-label x200">单元数：</label>
	           <input type="text" name="unit" id="unit" value="${unit }"  size="25">
	        </td>
	     </tr>
	     <tr>
	        <td>
	            <label for="floor" class="control-label x200">楼层数：</label>
	           <input type="text" name="floor" id="floor" value="${floor }"  size="25">
	        </td>
	     </tr>
	     <tr>
	        <td>
	            <label for="number" class="control-label x200">门牌号：</label>
	           <input type="text" name="number" id="number" value="${number }"  size="25">
	        </td>
	     </tr>
	     <tr>
	        <td>
	            <label for="housingarea" class="control-label x200">住房面积：</label>
	           <input type="text" name="housingarea" id="housingarea" value="${housingarea }"  size="25" onkeyup="Num(this)" >
	        </td>
	     </tr>
	      <tr>
	        <td>
     ...
     <input id = "villageids" value="${villageid }" type ="hidden" name="villageids"/>
     <input id = "decorationt" value="${decoration }" type ="hidden" name="decorationt"/>
     <input id = "repossessiont" value="${repossession }" type ="hidden" name="repossessiont"/>
     <input id = "checkstat" value="${checksta }" type ="hidden" name="checkstat"/>
    </form>
</div>
...
$(document).ready(
		function() {
			$("#villageid option[value=" + $("#villageids").val() + "]").attr("selected", true);
			$("#decoration option[value=" + $("#decorationt").val() + "]").attr("selected", true);
			$("#repossession option[value=" + $("#repossessiont").val() + "]").attr("selected", true);
			$("#checksta option[value=" + $("#checkstat").val() + "]").attr("selected", true);
		});
function Num(obj){
