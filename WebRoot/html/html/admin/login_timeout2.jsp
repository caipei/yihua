...
$(function() {
	...
	$("#login_ok").click(function(){
		...
		$.post("/<%=PropKit.get("project_name") %>/admin/verify", {username:username,password:password}, function (returnJson){
			...
			if (rescode == '0000') {
				$(this).alertmsg('ok', '登录成功', {displayMode:'slide', displayPosition:'topcenter', title:'登录成功', okCall:function() {
...
<div class="bjui-pageContent">
    <form action="/<%=PropKit.get("project_name") %>/admin/category/submit/" id="category_form" data-toggle="validate" data-alertmsg="false">
	<table class="table table-condensed table-hover" width="100%">
        <tbody>
    	<tr>
	        <td>
	            <label for="" class="control-label x85">用户名：</label>
	            <input type="text" name="username" id="username" value="" data-rule="required;" size="20">
	        </td>
