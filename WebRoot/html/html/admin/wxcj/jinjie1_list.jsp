...
<div class="bjui-pageHeader">
	<div class="pull-right">
         <button id="jinjie1_export" type="button" class="btn-blue" >导出</button>
   	</div>
	<form id="pagerForm" data-toggle="ajaxsearch" action="/<%=PropKit.get("project_name") %>/admin/wxcj/jinjie1list" method="post">
...
$(document).ready(function(){
	...
	$('#jinjie1_export').click(function() {
		var params = {};
		$.post("/<%=PropKit.get("project_name") %>/admin/wxcj/jinjie1_export", function (returnJson){
