...
<form action="/<%=PropKit.get("project_name") %>/admin/leysen/dyjzx/update" id="leysen_dyjzx_editform" data-toggle="validate" data-alertmsg="false">
        ...
        <tr>
	        <td style="display: flex; align-items: center;">
	            ...
	            <div style="display: inline-block; vertical-align: middle; flex: 1; margin-left: 4px;">
					<span id="leysen_dyjzx_edit_img_upload_span" class="img_thumbnail_add_span">
						<img class="img_upload" id="leysen_dyjzx_edit_img_upload" src="/<%=PropKit.get("project_name") %>/res/images/img_add.png">
					</span>
					<span id="leysen_dyjzx_edit_img_imgs_div">
...
$(document).ready(function(){
	...
	$.CurrentNavtab.find("#leysen_dyjzx_submit").click(function() {
		...
		var imgpath = '';
		$.CurrentNavtab.find('#leysen_dyjzx_edit_img_imgs_div img[name="img_thumbnail"]').each(function() {
			imgpath = $(this).attr('src');
		});
		$.CurrentNavtab.find('#imgpath').val(imgpath);
		
		$.CurrentNavtab.find("#leysen_dyjzx_editform").submit();
	});
	
	uploadimg('leysen_dyjzx_edit_', 1);
});
