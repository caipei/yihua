...
<form action="/<%=PropKit.get("project_name") %>/admin/brand/product_update/" id="brand_product_editform" data-toggle="validate" data-alertmsg="false">
	<table class="table table-condensed table-hover" width="100%">
        <tbody>
    	<tr>
	        <td>
	            <label for="name" class="control-label x100">名称：</label>
	            <input type="text" name="name" id="name" value="${name }" data-rule="名称:required;" placeholder="名称" size="64">
	        </td>
        </tr>
        <tr>
	        <td style="display: flex; align-items: center;">
	            ...
	            <div style="display: inline-block; vertical-align: middle;">
					<span id="brand_product_edit_img_upload_span" class="img_thumbnail_add_span">
						<img class="img_upload" id="brand_product_edit_img_upload" src="/<%=PropKit.get("project_name") %>/res/images/img_add.png">
					</span>
        ...
        <tr>
	        <td style="display: flex; align-items: center;">
	            ...
	            <div style="display: inline-block; vertical-align: middle; flex: 1">
					<span id="brand_product_edit_imgs_upload_span" class="img_thumbnail_add_span">
						<img class="img_upload" id="brand_product_edit_imgs_upload" src="/<%=PropKit.get("project_name") %>/res/images/img_add.png">
					</span>
					<span id="imgs_imgs_div">
					<c:forEach items="${imgs }" var="img">
					<c:if test="${!empty img.linkurl}">
						<span class="img_thumbnail_span">
...
<div class="bjui-pageFooter">
    <ul>
        ...
        <li><button id="brand_product_update" type="button" class="btn-default" data-icon="save">保存</button></li>
    </ul>
</div>
<script type="text/javascript">
$(document).ready(function(){
	
	$.CurrentNavtab.find("#brand_product_update").click(function() {
		...
		$.CurrentNavtab.find("#brand_product_editform").submit();
	});
	...
	var uploader1 = Qiniu1.uploader({
        ...
        browse_button: 'brand_product_edit_img_upload',
        container: 'brand_product_edit_img_upload_span',
        unique_names: true,
	...
	var uploader2 = Qiniu2.uploader({
        runtimes: 'html5,flash,html4',
        browse_button: 'brand_product_edit_imgs_upload',
        container: 'brand_product_edit_imgs_upload_span',
        unique_names: true,
        flash_swf_url: '/<%=PropKit.get("project_name") %>/res/BJUI/lib/plupload/js/Moxie.swf',
        dragdrop: false,
        chunk_size: '4mb',
