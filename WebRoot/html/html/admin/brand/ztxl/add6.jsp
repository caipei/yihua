	...
	<table class="table table-condensed table-hover" width="100%">
        ...
        <tr>
	        <td style="display: flex; align-items: center;">
	            ...
	            <div style="display: inline-block; vertical-align: middle; flex: 1">
					<span id="brand_ztxl_add_zhong_img_upload_span" class="img_thumbnail_add_span">
						<img class="img_upload" id="brand_ztxl_add_zhong_img_upload" src="/<%=PropKit.get("project_name") %>/res/images/img_add.png">
					</span>
					<span id="brand_ztxl_add_zhong_img_imgs_div">
					</span>
					<input id="brand_ztxl_add_zhong_imgpath" name="brand_ztxl_add_zhong_imgpath" type="hidden" value="" />
	            </div>
	        </td>
        </tr>
        <tr>
	        <td>
	            ...
	            <span id="product_zhong_dialog_span"></span>
	            <input id="product_zhong_dialog_id" name="product_zhong_dialog_id" type="hidden">
	        </td>
        </tr>
        <tr>
	        <td style="display: flex; align-items: center;">
...
$(document).ready(function(){
	...
	$.CurrentNavtab.find("#brand_ztxl_update").click(function() {
		...
		$.CurrentNavtab.find('#brand_ztxl_add_zhong_img_imgs_div img[name="img_thumbnail"]').each(function() {
			imgpath += '|' + $(this).attr('src');
		});
	...
	uploadimg('brand_ztxl_add_zhong_', 1);
