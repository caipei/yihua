...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 129, height: 100, top: 71, left: 134, $opacity: 0.5 },
            { '&zIndex': 2, width: 148, height: 115, top: 61, left: 0, $opacity: 0.6 },
            { '&zIndex': 3, width: 173, height: 134, top: 37, left: 110, $opacity: 0.7 },
            { '&zIndex': 4, width: 259, height: 202, top: 0, left: 262, $opacity: 1 },
            { '&zIndex': 3, width: 173, height: 134, top: 37, left: 468, $opacity: 0.7 },
            { '&zIndex': 2, width: 148, height: 115, top: 61, left: 620, $opacity: 0.6 },
            { '&zIndex': 1, width: 129, height: 100, top: 71, left: 496, $opacity: 0.5 }
        ]
