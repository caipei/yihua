...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="product_form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="name" type="text" class="form-control" value="${name }" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    $(document).ready(function(){
    	...
    	$('#submit').click(function() {
    		...
    		$.post('/<%=PropKit.get("project_name") %>/admin_new/brand/product_update/', $('#product_form').serialize(), function(returnJson) {
