...
<form action="/<%=PropKit.get("project_name") %>/admin/brand/csfc_update/" id="brand_csfc_editform" data-toggle="validate" data-alertmsg="false">
        ...
        <tr>
	        <td style="display: flex; align-items: center;">
	            ...
	            <div style="display: inline-block; vertical-align: middle; flex: 1">
					<span id="brand_csfc_edit_imgs_upload_span" class="img_thumbnail_add_span">
						<img class="img_upload" id="brand_csfc_edit_imgs_upload" src="/<%=PropKit.get("project_name") %>/res/images/img_add.png">
					</span>
...
<div class="bjui-pageFooter">
    <ul>
        ...
        <li><button id="brand_csfc_update" type="button" class="btn-default" data-icon="save">保存</button></li>
    </ul>
</div>
<script type="text/javascript">
$(document).ready(function(){
	
	$.CurrentNavtab.find("#brand_csfc_update").click(function() {
		...
		$.CurrentNavtab.find("#brand_csfc_editform").submit();
	});
	
	var Qiniu2 = new QiniuJsSDK();
	var uploader2 = Qiniu2.uploader({
        runtimes: 'html5,flash,html4',
        browse_button: 'brand_csfc_edit_imgs_upload',
        container: 'brand_csfc_edit_imgs_upload_span',
        unique_names: true,
