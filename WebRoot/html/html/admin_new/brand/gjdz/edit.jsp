...
<form action="/<%=PropKit.get("project_name") %>/admin/brand/gjdz_update/" id="brand_gjdz_editform" data-toggle="validate" data-alertmsg="false">
	<table class="table table-condensed table-hover" width="100%">
        <tbody>
    	<tr>
	        <td>
	            <label for="name" class="control-label x100">名称：</label>
	            <input type="text" name="name" id="name" value="高级定制" disabled="disabled" data-rule="名称:required;" placeholder="名称" size="64">
	        </td>
        </tr>
        <tr>
	        <td>
	            ...
	            <div style="display: inline-block; vertical-align: middle;">
					<span id="brand_gjdz_edit_img_upload_span" class="img_thumbnail_add_span">
						<img class="img_upload" id="brand_gjdz_edit_img_upload" src="/<%=PropKit.get("project_name") %>/res/images/img_add.png">
					</span>
...
<div class="bjui-pageFooter">
    <ul>
        ...
        <li><button id="brand_gjdz_update" type="button" class="btn-default" data-icon="save">保存</button></li>
    </ul>
</div>
<script type="text/javascript">
$(document).ready(function(){
	
	$.CurrentNavtab.find("#brand_gjdz_update").click(function() {
		...
		$.CurrentNavtab.find("#brand_gjdz_editform").submit();
	});
	
	var Qiniu2 = new QiniuJsSDK();
	var uploader2 = Qiniu2.uploader({
        runtimes: 'html5,flash,html4',
        browse_button: 'brand_gjdz_edit_img_upload',
        container: 'brand_gjdz_edit_img_upload_span',
        unique_names: true,
