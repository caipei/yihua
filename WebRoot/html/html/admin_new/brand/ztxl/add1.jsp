...
<form action="/<%=PropKit.get("project_name") %>/admin/brand/ztxl_submit/" id="brand_ztxl_editform" data-toggle="validate" data-alertmsg="false">
...
$(document).ready(function(){
	...
	$.CurrentNavtab.find("#brand_ztxl_update").click(function() {
		...
		$.CurrentNavtab.find("#brand_ztxl_editform").submit();
	});
