...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="hyzsqy_form">
                            ...
                            <div style="display: none" class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="content" name="content" style="width:700px;height:200px;">${content}</textarea> 
                                </div>
                            </div>
    ...
    $(document).ready(function(){
    	$('#submit').click(function() {
    		...
    		$.post('/<%=PropKit.get("project_name") %>/admin_new/mine/hyzsqy/update', $('#hyzsqy_form').serialize(), function(returnJson) {
