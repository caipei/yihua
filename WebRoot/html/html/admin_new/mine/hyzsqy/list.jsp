...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                    	<div class="">
                            <a href="/<%=PropKit.get("project_name") %>/admin_new/mine/hyzsqy/add" class="btn btn-primary ">新增</a>
                        </div>
    ...
    var datatable = null;
	        ...
	        $(document).ready(function(){
	            ...
	            datatable = $("#list_table").dataTable({
	                ...
	                ajax: function (data, callback, settings) {
	                    ...
	                    $.ajax({
	                        type: "GET",
	                        url: "/<%=PropKit.get("project_name") %>/admin_new/mine/hyzsqy/list_json",
	                        cache: false,  //禁用缓存
	                        data: param,  //传入组装的参数
	                        dataType: "json",
		...
		function edit(id) {
			window.location.href = '/<%=PropKit.get("project_name") %>/admin_new/mine/hyzsqy/edit?id=' + id;
		}
		...
		function del(id) {
			swal({
		    	...
		    	$.post('/<%=PropKit.get("project_name") %>/admin_new/mine/hyzsqy/del', {id:id}, function(returnJson) {
