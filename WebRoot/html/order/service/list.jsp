...
<div class="bjui-pageHeader">
	...
	<form id="pagerForm" data-toggle="ajaxsearch"
		action="/<%=PropKit.get("project_name")%>/admin/order/serviceorder/"
		method="post">
        ...
        <tbody>
        	<c:set var="index">1</c:set>
	      	...
	      	<tr data-id="${index }">
                ...
                <td>${info.intimes }</td>
                <td>
                	<a href="/<%=PropKit.get("project_name") %>/admin/order/serviceorder/del?id=${info.id }" class= "btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该行信息吗？">删除</a>
